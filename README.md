...
Open Sovereign AI Cloud (or whatever it will be called) hands-on lab
...
1. Open in DevSpaces: `https://devspaces.apps.ocpv-infra02.wdc07.infra.demo.redhat.com#https://github.com/rhpds/osac`
...
2. Clone the repo:
   ```
   git clone https://github.com/rhpds/osac
   ```
3. `cd osac`
